...
- **Caelan Mimi（沈知知 / mimi）** ——  角色卡作者，本项目发起人与所有人格设定的原创者。
- **Claude（Anthropic）** —— 本仓库代码的实际编写者，以及后期人格 prompt 的协作打磨者。
- **ChatGPT（OpenAI）** —— 早期角色设定撰写阶段的辅助工具。
...
允许在遵守上述全部条款的前提下：自用、改 prompt 让 Theo 更贴近你、写同人、画图、剪视频。不允许：商业化、去署名、声称原创、违反原始发布平台规则。
